...
@section('title', 'Profil ' . $user->nama . ' - MadingDigitally')
            ...
            <ul class="nav nav-tabs" id="profileTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="likes-tab" data-bs-toggle="tab" data-bs-target="#likes" type="button" role="tab">
                        <i class="bi bi-heart"></i> Like ({{ $likes->count() }})
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="comments-tab" data-bs-toggle="tab" data-bs-target="#comments" type="button" role="tab">
                        <i class="bi bi-chat"></i> Komentar ({{ $komentars->count() }})
                    </button>
                </li>
            </ul>
        </div>
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">Belum ada artikel yang dilike</p>
                        </div>
                    @endif
                </div>
            </div>
